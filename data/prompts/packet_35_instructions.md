# Task: author package #35 for "ჯეოპარდი"
...
`data/agy_packets/packet_35.json` matching this exact schema:

```json
{
  "number": 35,
  "title": "პაკეტი #35",
  "subtitle": "დროშები, გერბები და სიმბოლოები",
  "rounds": [
...
Subtitle: "დროშები, გერბები და სიმბოლოები" -- let this loosely color your topic choices, but the 6
...
`data/grounding/packet_35.txt` has real trivia facts pulled from a large
...
1. Write the file.
2. Run: `python src/validate_packets.py --against data/packets_all.json data/agy_packets/packet_35.json`

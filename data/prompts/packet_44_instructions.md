# Task: author package #44 for "ჯეოპარდი"
...
`data/agy_packets/packet_44.json` matching this exact schema:

```json
{
  "number": 44,
  "title": "პაკეტი #44",
  "subtitle": "ოკეანეთა სიცოცხლე და წყლის სამყარო",
  "rounds": [
...
Subtitle: "ოკეანეთა სიცოცხლე და წყლის სამყარო" -- let this loosely color your topic choices, but the 6
...
`data/grounding/packet_44.txt` has real trivia facts pulled from a large
...
1. Write the file.
2. Run: `python src/validate_packets.py --against data/packets_all.json data/agy_packets/packet_44.json`

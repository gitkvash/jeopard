# Task: author package #31 for "ჯეოპარდი"
...
`data/agy_packets/packet_31.json` matching this exact schema:

```json
{
  "number": 31,
  "title": "პაკეტი #31",
  "subtitle": "ძველი ცივილიზაციები",
  "rounds": [
...
Subtitle: "ძველი ცივილიზაციები" -- let this loosely color your topic choices, but the 6
...
`data/grounding/packet_31.txt` has real trivia facts pulled from a large
...
1. Write the file.
2. Run: `python src/validate_packets.py --against data/packets_all.json data/agy_packets/packet_31.json`

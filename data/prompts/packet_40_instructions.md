# Task: author package #40 for "ჯეოპარდი"
...
`data/agy_packets/packet_40.json` matching this exact schema:

```json
{
  "number": 40,
  "title": "პაკეტი #40",
  "subtitle": "დამწერლობა და ანბანები",
  "rounds": [
...
Subtitle: "დამწერლობა და ანბანები" -- let this loosely color your topic choices, but the 6
...
`data/grounding/packet_40.txt` has real trivia facts pulled from a large
...
1. Write the file.
2. Run: `python src/validate_packets.py --against data/packets_all.json data/agy_packets/packet_40.json`

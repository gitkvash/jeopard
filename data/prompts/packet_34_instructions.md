# Task: author package #34 for "ჯეოპარდი"
...
`data/agy_packets/packet_34.json` matching this exact schema:

```json
{
  "number": 34,
  "title": "პაკეტი #34",
  "subtitle": "თამაშები და გასართობები მსოფლიოში",
  "rounds": [
...
Subtitle: "თამაშები და გასართობები მსოფლიოში" -- let this loosely color your topic choices, but the 6
...
`data/grounding/packet_34.txt` has real trivia facts pulled from a large
...
1. Write the file.
2. Run: `python src/validate_packets.py --against data/packets_all.json data/agy_packets/packet_34.json`

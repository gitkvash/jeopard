# Task: author package #50 for "ჯეოპარდი"
...
`data/agy_packets/packet_50.json` matching this exact schema:

```json
{
  "number": 50,
  "title": "პაკეტი #50",
  "subtitle": "ბიომრავალფეროვნება — ეკოსისტემები და გადაშენებული სახეობები",
  "rounds": [
...
Subtitle: "ბიომრავალფეროვნება — ეკოსისტემები და გადაშენებული სახეობები" -- let this loosely color your topic choices, but the 6
...
`data/grounding/packet_50.txt` has real trivia facts pulled from a large
...
1. Write the file.
2. Run: `python src/validate_packets.py --against data/packets_all.json data/agy_packets/packet_50.json`

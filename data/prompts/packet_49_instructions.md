# Task: author package #49 for "ჯეოპარდი"
...
`data/agy_packets/packet_49.json` matching this exact schema:

```json
{
  "number": 49,
  "title": "პაკეტი #49",
  "subtitle": "პოლარული და მთის ექსპედიციები",
  "rounds": [
...
Subtitle: "პოლარული და მთის ექსპედიციები" -- let this loosely color your topic choices, but the 6
...
`data/grounding/packet_49.txt` has real trivia facts pulled from a large
...
1. Write the file.
2. Run: `python src/validate_packets.py --against data/packets_all.json data/agy_packets/packet_49.json`

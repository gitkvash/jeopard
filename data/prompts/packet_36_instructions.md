# Task: author package #36 for "ჯეოპარდი"
...
`data/agy_packets/packet_36.json` matching this exact schema:

```json
{
  "number": 36,
  "title": "პაკეტი #36",
  "subtitle": "მსოფლიოს ხალხური ტრადიციები და დღესასწაულები",
  "rounds": [
...
Subtitle: "მსოფლიოს ხალხური ტრადიციები და დღესასწაულები" -- let this loosely color your topic choices, but the 6
...
`data/grounding/packet_36.txt` has real trivia facts pulled from a large
...
1. Write the file.
2. Run: `python src/validate_packets.py --against data/packets_all.json data/agy_packets/packet_36.json`

# Task: author package #47 for "ჯეოპარდი"
...
`data/agy_packets/packet_47.json` matching this exact schema:

```json
{
  "number": 47,
  "title": "პაკეტი #47",
  "subtitle": "ცოდნის ისტორია — ბიბლიოთეკები და უნივერსიტეტები",
  "rounds": [
...
Subtitle: "ცოდნის ისტორია — ბიბლიოთეკები და უნივერსიტეტები" -- let this loosely color your topic choices, but the 6
...
`data/grounding/packet_47.txt` has real trivia facts pulled from a large
...
1. Write the file.
2. Run: `python src/validate_packets.py --against data/packets_all.json data/agy_packets/packet_47.json`

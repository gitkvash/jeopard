# Task: author package #43 for "ჯეოპარდი"
...
`data/agy_packets/packet_43.json` matching this exact schema:

```json
{
  "number": 43,
  "title": "პაკეტი #43",
  "subtitle": "არქეოლოგია და დაკარგული ცივილიზაციები",
  "rounds": [
...
Subtitle: "არქეოლოგია და დაკარგული ცივილიზაციები" -- let this loosely color your topic choices, but the 6
...
`data/grounding/packet_43.txt` has real trivia facts pulled from a large
...
1. Write the file.
2. Run: `python src/validate_packets.py --against data/packets_all.json data/agy_packets/packet_43.json`

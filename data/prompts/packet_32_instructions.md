# Task: author package #32 for "ჯეოპარდი"
...
`data/agy_packets/packet_32.json` matching this exact schema:

```json
{
  "number": 32,
  "title": "პაკეტი #32",
  "subtitle": "ფილოსოფია და აზრის ისტორია",
  "rounds": [
...
Subtitle: "ფილოსოფია და აზრის ისტორია" -- let this loosely color your topic choices, but the 6
...
`data/grounding/packet_32.txt` has real trivia facts pulled from a large
...
1. Write the file.
2. Run: `python src/validate_packets.py --against data/packets_all.json data/agy_packets/packet_32.json`

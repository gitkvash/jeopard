# Task: author package #46 for "ჯეოპარდი"
...
`data/agy_packets/packet_46.json` matching this exact schema:

```json
{
  "number": 46,
  "title": "პაკეტი #46",
  "subtitle": "სამედიცინო აღმოჩენები და ეპიდემიების ისტორია",
  "rounds": [
...
Subtitle: "სამედიცინო აღმოჩენები და ეპიდემიების ისტორია" -- let this loosely color your topic choices, but the 6
...
`data/grounding/packet_46.txt` has real trivia facts pulled from a large
...
1. Write the file.
2. Run: `python src/validate_packets.py --against data/packets_all.json data/agy_packets/packet_46.json`

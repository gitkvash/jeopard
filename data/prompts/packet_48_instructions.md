# Task: author package #48 for "ჯეოპარდი"
...
`data/agy_packets/packet_48.json` matching this exact schema:

```json
{
  "number": 48,
  "title": "პაკეტი #48",
  "subtitle": "კალენდარები და დროის აღრიცხვის ისტორია",
  "rounds": [
...
Subtitle: "კალენდარები და დროის აღრიცხვის ისტორია" -- let this loosely color your topic choices, but the 6
...
`data/grounding/packet_48.txt` has real trivia facts pulled from a large
...
1. Write the file.
2. Run: `python src/validate_packets.py --against data/packets_all.json data/agy_packets/packet_48.json`

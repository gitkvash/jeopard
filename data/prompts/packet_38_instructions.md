# Task: author package #38 for "ჯეოპარდი"
...
`data/agy_packets/packet_38.json` matching this exact schema:
...
Subtitle: "მსოფლიოს სამზარეულო" -- let this loosely color your topic choices, but the 6
...
`data/grounding/packet_38.txt` has real trivia facts pulled from a large
...
1. Write the file.
2. Run: `python src/validate_packets.py --against data/packets_all.json data/agy_packets/packet_38.json`

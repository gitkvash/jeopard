# Task: author package #42 for "ჯეოპარდი"
...
`data/agy_packets/packet_42.json` matching this exact schema:

```json
{
  "number": 42,
  "title": "პაკეტი #42",
  "subtitle": "მოდისა და საიუველირო ხელოვნების ისტორია",
  "rounds": [
...
Subtitle: "მოდისა და საიუველირო ხელოვნების ისტორია" -- let this loosely color your topic choices, but the 6
...
`data/grounding/packet_42.txt` has real trivia facts pulled from a large
...
1. Write the file.
2. Run: `python src/validate_packets.py --against data/packets_all.json data/agy_packets/packet_42.json`

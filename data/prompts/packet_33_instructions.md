# Task: author package #33 for "ჯეოპარდი"
...
`data/agy_packets/packet_33.json` matching this exact schema:
...
Subtitle: "ცხოველთა სამყარო" -- let this loosely color your topic choices, but the 6
...
`data/grounding/packet_33.txt` has real trivia facts pulled from a large
...
1. Write the file.
2. Run: `python src/validate_packets.py --against data/packets_all.json data/agy_packets/packet_33.json`
